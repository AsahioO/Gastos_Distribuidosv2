"""
Django base settings for Gastos Distribuidos project.
"""
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'API para gestión de adquisiciones y distribución de gastos',
    'VERSION': '2.0.0',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@gastosdistribuidos.com')
