"""
Development settings for Gastos Distribuidos project.
Uses SQLite and disables django-tenants for simpler local development.
"""
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_CLASSES': [],  # Disable throttling in dev
